...
def _notify_routine(
    ...
    """Executes the handler action and ensures proper and consistent logging.

    Args:
        debug_to_ui(bool): Whether to ouput the tracebacks of error occurring in the handlers to
            Fusions Userinterface with a messagebox.
...
class InputChangedHandler_(adsk.core.InputChangedEventHandler):
    def __init__(
        self, debug_to_ui: bool, cmd_name: str, event_name: str, action: Callable
    ):
...
class CommandCreatedHandler_(adsk.core.CommandCreatedEventHandler):
    def __init__(
        ...
        Args:
            debugToUi (bool): Whether to ouput the tracebacks of error occurring in the handlers to
                Fusions Userinterface with a messagebox.
            cmd_name (str):  The command name.
